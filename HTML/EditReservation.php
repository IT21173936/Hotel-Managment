...
<body>
    <section id="menu">
        ...
        <div class="items">
            ...
            <li><img src ="../images/customer.png"><a href="../HTML/adminCustomer.php" id="adcustomer"  class="adcustomer" >My Profile</a></li>
            <li><img src ="../images/reservation.jpg"><a href="../HTML/cusReservation.php" id="adreservation"  class="adreservation" >Reservations</a></li>
            <li><img src ="../images/reservation.jpg"><a href="../HTML/adminReservation.php" id="adreservation"  class="adreservation" >Payments</a></li>
    ...
    <section id="iterface">
        <div class="navigation">
                <div class="adminloggedin1">Welcome Customer!</div>
            <div class="admintop">
