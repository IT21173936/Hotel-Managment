	...
	<section style="width:70%">
		...
		<form action="paymentphp.php" method="post">
            ...
            <div class="col-50">
					...
					<input type="text" name="reservationno" id="reservation" placeholder="Enter the reservation number here..." required>
                    ...
                    <button style="width: 200px;" name="payment" style type="submit" value="submit" class="Btn1" onclick="round()"> Pay Now</button>
				</div>
			    </fieldset>
