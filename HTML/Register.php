...
margin-top: 0%;">
    ...
    <header>
                ...
                <div class="btn-packs">
                    ...
                    <!-- <div class="log">
                        <span><a a style="color: black;text-align: center;
                            padding:8px 0 0 0;font-family: 'Koulen', cursive; font-size: 25px; font-weight: 30px;" href="../HTML/Register.html">register</a></span>
                    </div> -->
                    <div class="avatar">
        ...
        <div>
            <button class="button1" ><button1 onclick="document.location='Customer._Register.php'">REGISTER FOR CUSTOMERS</button1>
            <button class="button2"><button2 onclick="document.location='Hotel_Register.php'">REGISTER FOR HOTELS</button2>
