...
<section>
    ...
    <div class="contentBx"> 
        ...
        <div class="inputBx" >
                <button type="submit" value="submit" class="Btn2" ><a href="Register.php"> Create An Account </a></button>
            </div>
           <div class="inputBx">
...
if(isset($_POST['submit']))
{
    ...
    $query = "SELECT * FROM STUDENT WHERE USERNAME = '$firstname' && password = '$pwd'";
