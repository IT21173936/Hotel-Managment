            ...
            <div class="fiex">
                ...
                <form action="Feedbackphp.php" method="post">
                    ...
                    <label for="name">Name</label>
                        ...
                        <input type="text" name="tele" id="Telephone" required>
    
                        <label for="email">email</label>
                        <input type="email" name="email" id="email" required>		
    
                        <label for="Subject">Subject</label>
                        <input type="text" name="sub" id="Subject" required>
    
                        <label for="Message">Message</label>
                        <textarea type="text" name="msg" id="Message" required></textarea>
                        
                        <button class="Btn1" name="feedback" onclick="round()">Submit</button>
                    </fieldset>
                    <br><br><br><br>
                    </form>
                </div>
