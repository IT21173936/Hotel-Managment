...
<html lang="en">
    ...
    <title>Reservation</title>
        ...
        <div class="bimage">
		    ...
		    <center>
		    <form action="adminReservationRegisterphp.php" method="POST">
		    ...
		    <fieldset>
                ...
                <label for="name">Hotel Name</label>
					...
					<input name="Cname" type="text" id="Customer Name" required>

                   <label for="Contact Number">Contact Number</label>
					<input name="ContactNo"  type="text" id="Contact Number" required>
					...
					<input name="TOWD" type="text" id="Type of Wedding Destination" required>

                    <label for="No.of serving">No.of servings</label>
					<input name="NOS" type="text" id="No.of servings" required>
					
                    <button name="reservation" type="submit" value="submit" class="Btn1">Check Availability & Price</button>
               </div>
		</div>	
		</fieldset>
		</form>
